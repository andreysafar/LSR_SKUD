...
def main():
    ...
    if page == "🏠 Dashboard":
        ...
        from views.cameras import show_cameras
        show_cameras()
        ...
        from views.batch_processing import show_batch_processing
        show_batch_processing()
    elif page == "📊 Analytics":
        from analytics.batch_analytics import show_batch_analytics
        show_batch_analytics()
    elif page == "🚪 Gate Events":
        from views.gate_events import show_gate_events
        show_gate_events()
...
def show_dashboard():
    ...
    st.markdown(
        '<div class="sub-header">License Plate Recognition & Access Control Dashboard</div>',
            ...
            for ev in events:
                ...
                <div class="event-card">
                    ...
                    <span style="margin-left:1rem;color:#7f8c8d;">
                        📷 {cam} | {ts} | Conf: {conf:.0%} {reviewed} {gate}
                    </span>
                </div>
                """, unsafe_allow_html=True)
        else:
            ...
            for cam in cameras:
                ...
                <div class="event-card">
                    ...
                    <small style="color:#7f8c8d;">
                        ID: {cam['camera_id']} | Last: {cam.get('last_frame_at', 'Never')}
                    </small>
                </div>
                """, unsafe_allow_html=True)
        else:
            st.info("No cameras configured. Add cameras in the Cameras page.")
